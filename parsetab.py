...
_lr_productions = [
  ...
  ('statement -> IF LPARENT expression RPARENT block','statement',5,'p_statement_if','sintactico.py',31),
  ('statement -> WHILE LPARENT expression RPARENT block','statement',5,'p_statement_while','sintactico.py',36),
  ...
  ('statement -> FUNCTION ID LPARENT VAR ID RPARENT block','statement',7,'p_statement_function','sintactico.py',50),
  ...
  ('expression -> expression LT expression','expression',3,'p_expression_comparison','sintactico.py',102),
  ('expression -> expression LTE expression','expression',3,'p_expression_comparison','sintactico.py',103),
  ('expression -> expression GT expression','expression',3,'p_expression_comparison','sintactico.py',104),
  ('expression -> expression GTE expression','expression',3,'p_expression_comparison','sintactico.py',105),
  ('expression -> expression NE expression','expression',3,'p_expression_comparison','sintactico.py',106),
  ('expression -> STRING','expression',1,'p_expression_string','sintactico.py',116),
  ('statement -> PRINT LPARENT expression RPARENT SEMICOLON','statement',5,'p_statement_print','sintactico.py',120),
  ('statement -> CALL ID LPARENT arguments RPARENT SEMICOLON','statement',6,'p_statement_summon','sintactico.py',125),
  ('arguments -> arguments COMMA expression','arguments',3,'p_arguments','sintactico.py',129),
  ('arguments -> expression','arguments',1,'p_arguments','sintactico.py',130),
  ('arguments -> empty','arguments',1,'p_arguments','sintactico.py',131),
  ('empty -> <empty>','empty',0,'p_empty','sintactico.py',141),
]
