...
_lr_productions = [
  ...
  ('program -> program statement','program',2,'p_program','sintactico.py',18),
  ('program -> statement','program',1,'p_program','sintactico.py',19),
  ('statement -> expression SEMICOLON','statement',2,'p_statement_expr','sintactico.py',22),
  ('statement -> VAR ID ASSIGN expression SEMICOLON','statement',5,'p_statement_assign','sintactico.py',26),
  ('statement -> ID ASSIGN expression SEMICOLON','statement',4,'p_statement_assign','sintactico.py',27),
  ('statement -> FUNCTION ID LPARENT RPARENT block','statement',5,'p_statement_function','sintactico.py',31),
  ('statement -> FUNCTION ID LPARENT VAR ID RPARENT block','statement',7,'p_statement_function','sintactico.py',32),
  ('statement -> IF LPARENT expression RPARENT block','statement',5,'p_statement_if','sintactico.py',41),
  ('statement -> WHILE LPARENT expression RPARENT block','statement',5,'p_statement_while','sintactico.py',46),
  ('statement -> FOR LPARENT statement SEMICOLON expression SEMICOLON expression RPARENT block','statement',9,'p_statement_for','sintactico.py',50),
  ('statement -> RETURN expression SEMICOLON','statement',3,'p_statement_return','sintactico.py',55),
  ('block -> LBRACE statements RBRACE','block',3,'p_block','sintactico.py',59),
  ('block -> LBRACE RBRACE','block',2,'p_block','sintactico.py',60),
  ('statements -> statements statement','statements',2,'p_statements','sintactico.py',67),
  ('statements -> statement','statements',1,'p_statements','sintactico.py',68),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','sintactico.py',71),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','sintactico.py',72),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','sintactico.py',73),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','sintactico.py',74),
  ('expression -> MINUS expression','expression',2,'p_expression_uminus','sintactico.py',81),
  ('expression -> LPARENT expression RPARENT','expression',3,'p_expression_group','sintactico.py',85),
  ('expression -> NUMBER','expression',1,'p_expression_number','sintactico.py',89),
  ('expression -> ID','expression',1,'p_expression_name','sintactico.py',93),
  ('expression -> expression LT expression','expression',3,'p_expression_comparison','sintactico.py',104),
  ('expression -> expression LTE expression','expression',3,'p_expression_comparison','sintactico.py',105),
  ('expression -> expression GT expression','expression',3,'p_expression_comparison','sintactico.py',106),
  ('expression -> expression GTE expression','expression',3,'p_expression_comparison','sintactico.py',107),
  ('expression -> expression NE expression','expression',3,'p_expression_comparison','sintactico.py',108),
  ('expression -> STRING','expression',1,'p_expression_string','sintactico.py',118),
  ('statement -> PRINT LPARENT expression RPARENT SEMICOLON','statement',5,'p_statement_print','sintactico.py',122),
  ('statement -> CALL ID LPARENT arguments RPARENT SEMICOLON','statement',6,'p_statement_summon','sintactico.py',127),
  ('arguments -> arguments COMMA expression','arguments',3,'p_arguments','sintactico.py',131),
  ('arguments -> expression','arguments',1,'p_arguments','sintactico.py',132),
  ('arguments -> empty','arguments',1,'p_arguments','sintactico.py',133),
  ('empty -> <empty>','empty',0,'p_empty','sintactico.py',143),
]
